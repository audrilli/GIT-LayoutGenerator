...
Function myDisplayDialog(myInCopy)
    ...
    If myResult = True Then
        ...
        myDialog.Destroy
        myAddTabStop myInCopy, myTabType, myTabLeader
    Else
       myDialog.Destroy
    End If
End Function
Rem Add the tab stop.
Function myAddTabStop(myInCopy, myTabType, myLeader)
    Select Case (myTabType)
        Case 0:
            Set myParagraphs = myInCopy.Selection.Item(1).Paragraphs
        ...
        Case 1:
            ...
            Set myInsertionPoint = myInCopy.Selection.Item(1).InsertionPoints.Item(1)
