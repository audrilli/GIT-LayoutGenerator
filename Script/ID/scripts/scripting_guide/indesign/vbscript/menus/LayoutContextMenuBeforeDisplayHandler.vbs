Rem LayoutContextMenuBeforeDisplayHandler.vbs
...
Rem ![Layout context menu before display handler.]
...
Function myGetFileName(myInDesign)
	myJavaScript = "myFilePath = File.openDialog(""Select the script file LabelGraphicOnInvoke.vbs"", ""VBScript files:*.vbs"");"
