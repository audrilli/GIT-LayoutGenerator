--LayoutContextMenuOnInvokeHandler.applescript
--An InDesign AppleScript
--
--Provides an event handler for the LayoutMenuLabelGraphic.applescript
--tutorial script. Adds a label to the selected graphic(s).
--![Layout context menu on invoke handler.]
