...
on mySetup()
	tell application "Adobe InDesign 2024"
		...
		set myColor to my myAddColor(myDocument, "Gray", RGB, process, {200, 200, 200})
		...
		tell page 1 of myMasterSpread
			set myTextFrame to make text frame with properties {geometric bounds:{0, 0, myPageHeight, myPageWidth}, contents:auto page number, fill color:myColor}
		end tell
