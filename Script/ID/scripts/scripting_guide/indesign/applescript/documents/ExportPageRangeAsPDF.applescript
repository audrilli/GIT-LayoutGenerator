--ExportPageRangeAsPDF.applescript
--An InDesign AppleScript
--
--Exports specified pages of an InDesign document to a PDF
...
on mySetup()
	...
	tell application "Adobe InDesign 2024"
		...
		set myFile to myDesktopFolder & "ExportPageRangeAsPDF.indd"
		tell myDocument
...
to mySnippet()
	tell application "Adobe InDesign 2024"
		...
		set myDesktopFolder to path to desktop as string
		set myFile to myDesktopFolder & "ExportPageRangeAsPDF.pdf"
