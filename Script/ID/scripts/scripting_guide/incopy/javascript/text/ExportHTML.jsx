...
function mySetup(){
	...
	myStory.paragraphs.item(0).applyParagraphStyle(myHeading1Style);
	myStory.paragraphs.item(1).applyParagraphStyle(myBodyTextStyle);
	myStory.paragraphs.item(2).applyParagraphStyle(myHeading2Style);
	myStory.paragraphs.item(3).applyParagraphStyle(myBodyTextStyle);
	myStory.paragraphs.item(4).applyParagraphStyle(myHeading3Style);
	myStory.paragraphs.item(5).applyParagraphStyle(myBodyTextStyle);
	var myStartCharacter = myStory.paragraphs.item(6).characters.item(0);
	var myEndCharacter = myStory.characters.item(-2);
