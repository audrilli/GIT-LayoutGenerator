...
Function mySnippet(myInCopy)
    ...
    Rem BackgroundColorForAddedText,The background color for added text, specified as an InCopy UI color. Note: Valid only when added background color choice is change background uses change pref color. Type: Array of 3 Doubles (0 - 255) or idInCopyUIColors enumerator
    ...
    Rem BackgroundColorForMovedText,The background color for moved text, specified as an InCopy UI color. Note: Valid only when moved background color choice is change background uses change pref color
    ...
    Rem  idChangeBackgroundUsesUserColor  The background color for changed text is the same as the color assigned to the current user. 
	  ...
	  .ShowChangeBars = true
		...
		Rem TextColorForAddedText, The color for added text, specified as an InCopy UI color. Note: Valid only when added text color choice is change uses change pref color.	
