...
on mySnippet()
	tell application "Adobe InCopy 2024"
		...
		tell myTrackChangesPreference
			...
			--background color for added text (any) : The background color for added text, specified as an InCopy UI color. Note: Valid only when added background color choice is change background uses change pref color. Can return: list of 3 fixed (0 - 255) or canary/lemon/electrolyte/lime/forest/lichen/...
			set myBackgroundColorForAddedText to background color for added text
			set background color for added text to gray
			
			--background color for deleted text (any) : The background color for deleted text, specified as an InCopy UI color. Note: Valid only when deleted background color choice is change background uses change pref color. Can return: list of 3 fixed (0 - 255) or canary/lemon/electrolyte/lime/forest/lic...
			set myBackgroundColorForDeletedText to background color for deleted text
			set background color for deleted text to red
			
			--background color for moved text (any) : The background color for moved text, specified as an InCopy UI color. Note: Valid only when moved background color choice is change background uses change pref color. Can return: list of 3 fixed (0 - 255) or canary/lemon/electrolyte/lime/forest/lichen/...			
			...
			--The color for added text, specified as an InCopy UI color. Note: Valid only when added text color choice is change uses change pref color. Can return: list of 3 fixed (0 - 255) or canary/lemon/electrolyte/lime/forest/lichen/jade/aqua/cirrus/ether/slate....	
			set myTextColorForAddedText to text color for added text
			set text color for added text to blue
			
			--  text color for deleted text (any) : The color for deleted text, specified as an InCopy UI color. Note: Valid only when deleted text color choice is change uses change pref color. Can return: list of 3 fixed (0 - 255) or canary/lemon/electrolyte/lime/forest/lichen/jade/aqua/cirrus/ether/s...			
			set myTextColorForDeletedText to text color for deleted text
			set text color for deleted text to yellow
			
			--  The color for moved text, specified as an InCopy UI color. Note: Valid only when moved text color choice is change uses change pref color. Can return: list of 3 fixed (0 - 255) or canary/lemon/electrolyte/lime/forest/lichen/jade/aqua/cirrus/ether/slate...
