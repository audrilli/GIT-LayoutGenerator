--ExportHTML.applescripttell application "Adobe InCopy 2024"tell application "Adobe InCopy 2024"tell application "Adobe InCopy 2024"
							...
							if (count text style ranges of myParagraph) is 1 then
								...
								repeat with myRangeCounter from 1 to (count text style ranges of myParagraph)
									...
									if character -1 of myTextStyleRange is return then
										set myText to object reference of text from character 1 to character -2 of myTextStyleRange
										set myString to contents of myText
									else
										set myString to contents of myText
									end if
							...
							repeat with myRowCounter from 1 to (count rows of myTable)
								...
								repeat with myColumnCounter from 1 to (count columns of myTable)
									if myRowCounter = 0 then
										set myString to "<th>"
										set myString to myString & text of cell myColumnCounter of row myRowCounter of myTable
